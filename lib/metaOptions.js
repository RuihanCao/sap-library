...
// The filter options are derived entirely from JSON bundled with the app, so
// they never change between deploys. Build them once and memoize — every meta
// request after the first reuses this without recomputing.
...
function buildMetaOptions() {
  ...
  cachedOptions = { pets, perks, toys, packs };
  return cachedOptions;
}

module.exports = { buildMetaOptions };
